...
public class HSBColourScript : MonoBehaviour {
	...
	*/
	...
	/*
    public hsbColor HSBColor(float h, float s, float b, float a)
    {
        this.h = h;
        this.s = s;
        this.b = b;
    ...
    public hsbColor HSBColor(float h, float s, float b)
    {
        this.h = h;
        this.s = s;
        this.b = b;
    ...
    public hsbColor HSBColor(Color col)
    {
